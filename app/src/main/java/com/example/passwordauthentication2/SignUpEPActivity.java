...
public class SignUpEPActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {  // Sign in success, update UI with the signed-in user's information
                            ...
                            user = FirebaseAuth.getInstance().getCurrentUser();
                            // alert
                            Toast.makeText(SignUpEPActivity.this, "Account created. Welcome!", Toast.LENGTH_SHORT).show();
                            // update view
                            Intent intent = new Intent(SignUpEPActivity.this, MainActivity.class);
                            startActivity(intent);
                        }
                        else {  // If sign in fails, display a message to the user.
                            Toast.makeText(SignUpEPActivity.this, "Create user failed.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
